  ...
  const Feed = (props) => {
    ...
    return (
      <>
        ...
        <TouchableOpacity
          onPress={() => {
            setSelectedComments(props.item.feed.comments);
            setBottomSheetVisible(true);
          }}
        >
          <Text style={{ color: "gray" }}>
            View All {props.item.feed.comments.length} Comments
          </Text>
        </TouchableOpacity>
  ...
  return (
    <View>
      ...
      <Portal>
        ...
        >
          <FeedComments comments={selectedComments}/>
        </BottomSheet>
      </Portal>
    </View>
  );
      ...
      comments: [
        {
          ...
          imageUrl:
            "https://play-lh.googleusercontent.com/KnFMQzTkrsWoyFZPDovbEGxYbrJF_37APuzIPhYCT_dAFRBKCu57sDiezvQBxoSd5s4=w240-h480-rw",
          comment: "Virgo Fajar Sevenfoldism 201m"
        },
        {
          name: "Wibi1",
          imageUrl:
